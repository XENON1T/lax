...
class MuonVeto(Lichen):
    """Remove events in coincidence with Muon Veto events
    ...
    The event is excluded if the nearest MV trigger falls in a 1ms time window before the reference position
    ...
    def _process(self, df):
        ...
        cond2 = (df['event_duration'] / 2) - 1001000 + df['nearest_muon_veto_trigger'] > self.not_allowed_range[1]
